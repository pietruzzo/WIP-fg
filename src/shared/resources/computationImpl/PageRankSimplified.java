...
/**
 * Monkey Implementation of PageRank, not properly working but giving approximated performance of PageRank
 * Kept only for performance comparison with old solutions
 *
 * Parameters:
 *          0: maxIterations
 ...
 *          0: Rank label name
 */
public class PageRankSimplified extends Computation {
